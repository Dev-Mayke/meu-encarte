...
import "./painel.css";
import logo from "../logo-encarte-horizontal-branco.png";
...
function Painel() {
  ...
  const produtos = [
    ...
    },
    {
      ...
      descricao:
        "Auxilia na imunidade. Sabor laranja, tubo com 10 comprimidos.",
      imagem: "/imagem2.png",
      preco: "R$ 14,90",
      categoria: "vitaminas",
    },
    ...
    },
    {
      ...
      descricao:
        "Embalagem com 50 unidades, ideal para uso em serviços de saúde.",
      imagem: "/imagem9.png",
      preco: "R$ 15,00",
      categoria: "higiene",
    },
    ...
    },
    {
      ...
      descricao:
        "Proteção solar de amplo espectro. Ideal para todos os tipos de pele.",
      imagem: "/imagem11.png",
      preco: "R$ 39,90",
      categoria: "cosmeticos",
    },
    {
      ...
      descricao:
        "Solução isotônica para limpeza e hidratação. Embalagem com 500ml.",
      imagem: "/imagem12.png",
      preco: "R$ 7,90",
      categoria: "medicamentos",
    },
      ...
      <header className="headerPainel">
        ...
        <div className="options">
          <div className="perfil">
            <img src="/perfil.jpg" alt="perfil" className="perfil-img" />
          </div>
        </div>
      </header>

      <div className="main-content">
        <button className="filtros-btn" onClick={abrirFiltros}>
          Filtros
        </button>

        <aside className={`filtros-barra ${filtrosAbertos ? "aberto" : ""}`}>
          <button className="close-btn" onClick={abrirFiltros}>
              ...
              {produtosFiltrados.map((produto) => (
                <div className="produto-card" key={produto.id}>
                  ...
                  <button
                    ...
                    onClick={() => adicionarAoEncarte(produto)}
                  >
